...
var _a;
var NetlifyRequest = class extends (_a = BaseRequest, requestFlags, requestRoute, _a) {
};
...
var getPathParameters = (path, url) => {
  ...
  const match = (_a2 = matcher.exec(trimmedURL)) == null ? void 0 : _a2.pathname.groups;
  if (!match) {
    return {};
  }
...
var setEnvironmentContext = (headers, event, lambdaContext) => {
  var _a2, _b;
  const { blobs } = event;
  const purgeAPIToken = (_b = (_a2 = lambdaContext == null ? void 0 : lambdaContext.clientContext) == null ? void 0 : _a2.custom) == null ? void 0 : _b.purge_api_token;
...
var systemLog = (msg, fields) => {
  if (env3.NETLIFY_DEV) {
    return;
  }
  console.log("__nfSystemLog", { msg, fields });
};
...
var addHeaders = (request) => {
  ...
  if (store == null ? void 0 : store.cdnLoopHeader) {
    if (request.headersSent) {
      systemLog("Headers already sent, cannot add CDN-Loop header");
      return;
    }
